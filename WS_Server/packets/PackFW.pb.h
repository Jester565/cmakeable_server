...
class PackHeaderIn : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ProtobufPackets.PackHeaderIn) */ {
 public:
  ...
  #if LANG_CXX11
  void set_lockey(::std::string&& value);
  #endif
 ...
 private:
  ...
  friend struct protobuf_PackFW_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
#if LANG_CXX11
inline void PackHeaderIn::set_lockey(::std::string&& value) {
...
#if LANG_CXX11
inline void PackHeaderOut::set_lockey(::std::string&& value) {
