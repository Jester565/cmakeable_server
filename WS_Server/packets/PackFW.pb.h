...
class PackHeaderIn : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ProtobufPackets.PackHeaderIn) */ {
 public:
  ...
  static const PackHeaderIn* internal_default_instance();
  ...
  void UnsafeMergeFrom(const PackHeaderIn& from);
  private:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<PackHeaderIn> PackHeaderIn_default_instance_;
...
class PackHeaderOut : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ProtobufPackets.PackHeaderOut) */ {
 public:
  ...
  static const PackHeaderOut* internal_default_instance();
  ...
  void UnsafeMergeFrom(const PackHeaderOut& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<PackHeaderOut> PackHeaderOut_default_instance_;
